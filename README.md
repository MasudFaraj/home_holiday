...
```
cd existing_repo
git remote add origin https://gitlab.it-bildungshaus.de/holidayhome/holidayhome.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.it-bildungshaus.de/holidayhome/holidayhome/-/settings/integrations)
...
slowed down or stopped completely. Someone may choose to fork your project or volunteer to step in as a maintainer or
owner, allowing your project to keep going. You can also make an explicit request for maintainers.
>>>>>>> 75b098f (project in Repo anlegen)
